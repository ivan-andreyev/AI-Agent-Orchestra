        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DefaultBranch = table.Column<string>(type: "TEXT", maxLength: 100, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Name = table.Column<string>(type: "TEXT", maxLength: 255, nullable: false),
                    Description = table.Column<string>(type: "TEXT", maxLength: 1000, nullable: true),
                    CommandTemplate = table.Column<string>(type: "TEXT", maxLength: 2000, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CurrentTask = table.Column<string>(type: "TEXT", maxLength: 128, nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "TEXT", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "TEXT", nullable: false),
                    ...
                    HealthCheckInterval = table.Column<long>(type: "INTEGER", nullable: false),
                    ...
                    TotalExecutionTime = table.Column<long>(type: "INTEGER", nullable: false),
                    AverageExecutionTime = table.Column<double>(type: "REAL", nullable: false),
                    SessionId = table.Column<string>(type: "TEXT", maxLength: 128, nullable: true),
                    RepositoryId = table.Column<string>(type: "TEXT", maxLength: 128, nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ExecutionDuration = table.Column<long>(type: "INTEGER", nullable: true),
                    ...
                    ParentTaskId = table.Column<string>(type: "TEXT", maxLength: 128, nullable: true),
