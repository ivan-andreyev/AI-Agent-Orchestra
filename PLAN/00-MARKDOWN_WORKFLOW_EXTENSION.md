...
- [ ] MarkdownArtifactManager для работы с .md документами
...
### 📋 [Фаза 2: Claude Code Integration](./00-MARKDOWN_WORKFLOW_EXTENSION/02-Claude-Code-Integration.md)
**Приоритет**: ВЫСОКИЙ
**Зависимости**: Фаза 1 завершена
**Цель**: Добавить реальную интеграцию с Claude Code агентами

- [ ] Расширение IAgentConnector для специфики Claude Code
- [ ] ClaudeCodeAgentConnector с реальными командами
- [ ] Интеграция с существующим AgentScheduler
- [ ] Обновление SimpleOrchestrator для работы с Claude Code
- [ ] Тестирование реального взаимодействия с агентами
